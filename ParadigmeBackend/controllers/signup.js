                                ...
                                <tbody>
                                   <tr>
                                      <td align="center" style="font-size:0px;padding:0px 25px;word-break:break-word">
                                         <div style="font-family:Arial,sans-serif;font-size:13px;line-height:25px;text-align:left;color:#fff"><b>Paradigme Team

                                         </b></div>
                                      </td>
                                      <td align="center" style="font-size:0px;padding:0px 25px;word-break:break-word">
                                         <div style="font-family:Arial,sans-serif;font-size:13px;line-height:25px;text-align:right;color:#fff"><b style="color:white"><a href="mailto:support@paradigme.io" target="_blank">support@paradigme.io</a></b></div><font color="#888888">
...
exports.getUserDetails = async (db, req, res) => {
    ...
    await db.query(authQueries.getUserdetails, [id], function (error, data) {
        if (error) {
            return res.status(400).send({
                success: false,
                msg: "error occured",
...
//  >>>>>>>>>>>>>>>>>>>>>>>>>.  Freshers learning API

exports.registration = async (db, req, res) => {
...
exports.userlogin = async (db, req, res) => {
    let email = req.body.email;
    let password = req.body.password;
    try {
        if (email == '') {
