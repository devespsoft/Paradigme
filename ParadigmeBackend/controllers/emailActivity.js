                        ...
                        <td colspan="2" align="center" bgcolor="#333333" style="text-align:center;width:100%;padding:12px 0px;border-bottom:1px solid #eaeaea">
                            <div>
                                <a href="#" target="_blank" >
                                    <img align="left" alt="Paradigme Logo" src="${config.mailUrl}images/logo.png" width="180" style="max-width:400px;padding-bottom:0;display:inline!important;vertical-align:bottom;border:0;height:auto;outline:none;text-decoration:none,margin-left:38%" class="CToWUd">                              </a>                          </div>
                        </td>
                      </tr>
                        <tr>
                            <td colspan="2">
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td style="text-align:left">
                                                    <span style="color:#37393a;font-size:1em;display:block;font-weight:normal;font-family:'Helvetica Neue',Helvetica,Arial,Geneva,sans-serif">Regards <br /> — Paradigme Team</span>                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                          </td>
