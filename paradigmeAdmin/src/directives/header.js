                ...
                <div className="nav-header pull-left">
                    <div className="logo-wrap">
                        <a href={`${config.baseUrl}dashboard`}>
                            <img className="brand-img" src="images/paradigme.png" alt="brand" style={{width:"80px",borderRadius:"50%"}} />
            ...
            <div id="mobile_only_nav" className="mobile-only-nav pull-right">
                <ul className="nav navbar-right top-nav pull-right">
                    ...
                    <li className="dropdown auth-drp">
                        <a href="#" className="dropdown-toggle pr-0" data-toggle="dropdown"><img src={`${config.imageUrl1}/${this.state.profile_pic.profile_pic}`} alt="" className="user-auth-img img-circle" /><span className="user-online-status"></span></a>
