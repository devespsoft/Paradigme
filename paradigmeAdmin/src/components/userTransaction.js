...
export default class userTransaction extends Component {
        ...
        this.columns = [
        ...
        
            {
                ...
                cell: (item) => {
                    return (
                        <td nowrap="nowrap">
                            {item.purchase_datetime.slice(0, 10)}
                        </td>
                    );
                }
            },
    ...
    async userTransaction() {
        ...
        await axios.post(`${config.apiUrl}getUserTransaction`, data, { headers })
            .then(result => {
                        ...
                        <div className="pcoded-wrapper">
                            ...
                            <div className="page-wrapper nft-user">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active">User Transaction</li>
                                    {/* <li class="active"><a data-toggle="tab">NFT's</a></li> */}
                                    <li> <a href={`${config.baseUrl}userDetail/${this.userid}`}>NFT's</a></li>
                                </ul>
{/* 
