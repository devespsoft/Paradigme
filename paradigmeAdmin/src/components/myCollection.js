        ...
        this.columns = [
            ...
            },
            {
                ...
                cell: (item) => {
                    return (
                        <>
                            {parseInt(item.nftCount) > 0 ?
                            <>
                                <button className=" btn-danger" data-tip={`You can't delete this collection because NFTs exists in this collection.`} aria-hidden="true"> <i class="fa fa-trash" aria-hidden="true"></i></button>
                                <ReactTooltip />
                            </>
                            :
