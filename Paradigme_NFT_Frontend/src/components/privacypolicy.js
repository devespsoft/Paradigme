...
<p>If you are based in the United Arab Emirates, or any other territory which relies upon your consent as the legal basis for processing, your continued use of our website means that you understand and agree that we will process your Personal Information in accordance with this Privacy Policy. If you do not wish for your Personal Information to be processed as set out in this Privacy Policy, please do not visit our website.</p>
              ...
              <p>- <b>Usage Data,</b> such as system activity, internal and external information related to paradigme pages that you visit, clickstream information; and</p>
...
<p>- <b>Protect the security and integrity of our Services.</b> We use your Personal Information, including information about your device and your activity on paradigme to maintain the security of your account and the paradigme platform. </p>
...
<p className="privacyTems">When you access our website at paradigme, we may make use of the standard practice of placing tiny data files called cookies, flash cookies, pixel tags, or other tracking tools (herein, “Cookies”) on your computer or other devices used to visit paradigme. We use Cookies to help us recognize you as a customer, collect information about your use of paradigme to better customize our services and content for you, and collect information about your computer or other access devices to: 
<br/>
...
<p>- <b>Contractual Obligation:</b> to satisfy our obligations to you under our Terms of Use, including to provide you with our Services and customer support services, and to optimize and enhance paradigme;</p>
<p>- <b>Legitimate Interest:</b> to monitor the usage of paradigme, conduct automated and manual security checks of our Services, to protect our rights; and</p>
<p>- <b>Consent</b> to market paradigme and our Services. You may withdraw your consent at any time without affecting the lawfulness of processing based on consent before consent is withdrawn. </p>
...
<ul className="indent">
  ...
  <p> <b>- Right to Erasure.</b> You may submit a request that paradigme deletes the Personal Information that we have about you. This is not an absolute right and is only excercisable under certain circumstances, including: </p>
...
<p><b>The marketplace of paradigme operates with many of our systems based in the United Arab Emirates. As a result, we may transfer</b>
<p>Personal Information</p>
<b>from Europe to third countries outside of Europe, including United Arab Emirates, under the following conditions:</b>
</p>

<div className="indent">
  <p><b>- Contractual Obligation. Where transfers are necessary to satisfy our obligation to you under our Terms of Use, including to provide you with our Services and customer support services, and to optimize and enhance paradigme; and</b></p>
...
<p>You are welcome to e-mail us at any time at legal@infinity.io. if you have any questions regarding our Privacy Policy Agreement. You can also contact us by writing to us at: 00, 3rd floor Dubai South Business Center, Dubai, United Arab Emirates. </p>
...
<p>If you have a complaint or concern about how we use your Personal Information, please contact us in the first instance and we will attempt to resolve the issue as soon as possible. You also have a right to lodge a complaint with your national data protection supervisory authority at any time.</p>
                ...
                {/* <ol className="indent">
                    ...
                    <ol type="a" className="indent">
                      <li>
                        ...
                        <ol type="i" className="indent">
                          <li>
                            <p>
                              You may access, correct, amend, or delete your User Materials by accessing your user account (including any imported contacts). You control all User Materials you upload. User Materials that you delete (including User Materials containing personal information) may be retained in archived or backup copies in order to enable you to use certain features like revision history and base snapshots. For instructions on how to permanently delete User Materials from your account, please contact us at <a href="#">support@paradigme.com</a>. Please note that permanent deletion of your User Materials through this process will impair or disable those features with respect to that User Materials.
                            </p>
                          </li>
                          <li>
                            <p>
                          ...
                          <li>
                            <p>
                              We may use some of the information we collect for marketing purposes, including to send you promotional communications about new paradigme features, products, events, or other opportunities. If you wish to stop receiving these communications or to opt out of use of your information for these purposes, please follow the opt-out instructions by clicking "Unsubscribe" (or similar opt-out language) in those communications. You can also contact us at <a href="#">support@paradigme.com</a> to opt out.
                            </p>
                          </li>
                        </ol>
                      </li>
                  ...
                  <li>
                    <p><strong>Changes to This Privacy Policy</strong>. This Privacy Policy may be updated from time to time for any reason. We will notify you of any changes to our Privacy Policy by posting the new Privacy Policy <a href="#">https://paradigme.com/privacy</a>. The date the Privacy Policy was last revised is identified at the beginning of this Privacy Policy. You are responsible for ensuring we have an up-to-date active and deliverable email address for you, and for periodically visiting our Site and this Privacy Policy to check for any changes.</p>
                  </li>
                </ol>
          */}
