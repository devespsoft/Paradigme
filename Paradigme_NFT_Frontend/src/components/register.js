                    ...
                    <div className="container-login100">
                      <div className="">
                        <form className="login100-form validate-form" autoComplete="on">
                          ...
                          <div className="flex-sb-m w-full mt-0 ">
                            <div className="contact100-form-checkbox pt-4">
                              ...
                              <label className="label-checkbox100" for="ckb1">
                                Stay up to date with Digiphynft
                          ...
                          <br />
                          <p className="text-white mb-3">By signing up, you agree to the <a href='javascript:void();'>
                            Terms and Conditions</a> and &nbsp;
                            <a href='javascript:void();' >Privacy Policy</a>.</p>
                          {/* <p className="text-white mb-3">By signing up, you agree to the <Link to={`${config.baseUrl}termscondition`} target="_blank">
                            Terms and Conditions</Link> and &nbsp;
                            <Link to={`${config.baseUrl}privacypolicy`} target="_blank">Privacy Policy</Link>.</p> */}
                          <br />
