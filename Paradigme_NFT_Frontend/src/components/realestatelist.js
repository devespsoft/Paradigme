                        ...
                        <div className="row">
                              ...
                              <div className="row">
                                 ...
                                 <div className="col-sm-3">
                                    <div className="be-vidget back-block mb-4 btn-right">
                                       <a className="btn full btn-primary size-1 hover-2" onClick={this.loginCheck1.bind(this)} >Create your own Listing</a>
                                    </div>
                                 </div>
                           ...
                           <div className="col-md-12">
                              ...
                              {this.state.getitemData === '' ?
                                 ...
                                 this.state.getitemData1 === true ? <h4 className="text-center upcomigClass">There isn't any assets available.</h4>
                                    :
