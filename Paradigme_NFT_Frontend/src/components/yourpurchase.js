   ...
   constructor(props) {
      ...
      this.columns = [
         ...
         },
         {
            ...
            cell: (item) => {
               return (
                  <span>${parseFloat(item.bid_price).toFixed(2)}</span>
               );
            }
         },
         ...
         },
         {
            ...
            cell: (item) => {
               return (
                  <>
                     {item.status === 'Pending' ?
                        <button onClick={this.bidCancel.bind(this, item)} style={{ textTransform: 'inherit' }} className="btn btn-danger">Cancel</button> : ''
                           ...
                           <div className="be-vidget">
                              <div className="creative_filds_block">
                                 <ul className="ul nav">
                                    ...
                                    <li className="edit-ln active" ><Link onClick={this.loading.bind(this, '4')} to={`${config.baseUrl}yourpurchase`}>Purchase and Bids</Link></li>
                        ...
                        <>
                           <div className="modal-body mx-3">
                              ...
                              <div className="md-form ">
                                 ...
                                 <div data-error="wrong" data-success="right" for="defaultForm-email">Resell Price (USD)<span className="error-asterick"> *</span></div>
                                 {/* <br /> */}
                                 <input type="text" onKeyPress={(event) => {
                                    if (!/^\d*[.]?\d{0,1}$/.test(event.key)) {
                                       event.preventDefault();
                                    }
                                 }} name="price" onChange={this.onChange} value={this.state.price} className="form-control validate" />
                              </div>
                              <br />
                              <div className="md-form">
                                 {/* <i className="fas fa-lock prefix grey-text"></i> */}
                                 <div data-error="wrong" data-success="right" for="defaultForm-pass">Expiry Date<span className="error-asterick"> *</span></div>
                                 {/* <br /> */}
                              ...
                              <div className="row">
                                 <div className="md-form ">
                                    <div data-error="wrong" style={{ marginLeft: '15px' }} data-success="right" for="defaultForm-pass">Quantity<span className="error-asterick"> *</span></div>
                           ...
                           <div className="modal-footer d-flex justify-content-center">
                              ...
                              <>
                                 ...
                                 <button type="submit" onClick={this.resellSubmitAPI} className="btn btn-primary col-sm-12 size-1" disabled={!this.state.price || this.state.price === '0' || !this.state.expiry_date || this.state.resellBtnText || !this.state.resale_quantity || !(this.state.resale_quantity <= this.state.sellItem.resale_available)}>{(this.state.resellBtnText) ? 'Processing...' : 'Continue'}</button>
                                 {/* <button type="submit" onClick={this.resellSubmitAPI} className="btn btn-primary col-sm-12 size-1" disabled={!this.state.price || this.state.price === '0' || !this.state.expiry_date || this.state.resellBtnText}>{(this.state.resellBtnText) ? 'Processing...' : 'Continue'}</button> */}
                                 {/* : */}
