...
export default class paymentsetting extends Component {
                      ...
                      <div className="col-sm-12 background-shadow p-5">
                          ...
                          <div className="row">
                              <div className="col-sm-6">
                                 ...
                                 {this.state.getWalletDetailAPIData?.eth_balance === null || this.state.getWalletDetailAPIData?.eth_balance === undefined || this.state.getWalletDetailAPIData?.eth_balance === '' ? 0 : this.state.getWalletDetailAPIData?.eth_balance } ETH ~ $
                                 {this.state.getWalletDetailAPIData?.usd_balance === null || this.state.getWalletDetailAPIData?.usd_balance === undefined || this.state.getWalletDetailAPIData?.usd_balance === '' ? 0 : this.state.getWalletDetailAPIData?.usd_balance } USD</p>
   ...
   }} placeholder="ETH" value={this.state.amount}
                                 onChange={this.onChange}/></div>
                                 
    <div class="col-sm-4"><div style={{paddingTop:'5px',wordBreak:'break-all'}}>~ ${parseFloat(this.state.amount* this.state.getWalletDetailAPIData?.eth_usd_value).toFixed(2)}USD</div> </div>
</div>
                                 <br/>
