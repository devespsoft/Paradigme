                              ...
                              <div className="creative_filds_block">
                                 <ul className="ul nav">
                                    {this.state.talentStatusAPIData?.telent_status === 1 ?
                                       <li className="edit-ln" ><Link to={`${config.baseUrl}featurescreator/${this.loginData.data.id}`}>My Profile</Link></li>
                                       : ''

                                    }
                                    <li className="edit-ln" ><Link to={`${config.baseUrl}authoredit`}>Account Setting</Link></li>
                                    <li className="edit-ln" ><Link to={`${config.baseUrl}about`}>About</Link></li>
                                    <li className="edit-ln" ><Link to={`${config.baseUrl}salehistory`}>Sell History</Link></li>
                                    <li className="edit-ln active" ><Link to={`${config.baseUrl}yourpurchase`}>Purchase and Bids</Link></li>
                                    <li className="edit-ln" ><Link to={`${config.baseUrl}paymentsetting`}>Wallet</Link></li>
                                    {/* <li className="edit-ln" ><Link to={`${config.baseUrl}royalty`}>Royalty</Link></li> */}
                                 </ul>
                              </div>
                           </div>
                        </div>
                                 ...
                                 <div className="row">
                                    <div className="col-ml-12 col-xs-12 col-sm-12">
                                       ...
                                       <div className="col-12 mt-3">
                                          ...
                                          if (!/^[0-9\b]+$/.test(event.key)) {
                                            event.preventDefault();
                                                ...
                                                placeholder="Card Number" name="cardNumber" onChange={this.onChange} value={this.state.cardNumber} />
                                          </div>
                                       </div>
                                       ...
                                       <div className="row">
                                        ...
                                        }} className="form-control " placeholder="CVC" name="cvc" onChange={this.onChange} value={this.state.cvc} />
                                             </div>
                                          </div>
                                       </div>
