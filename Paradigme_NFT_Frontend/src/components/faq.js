                        ...
                        <div className="tab-wrapper style-2">
                           <div className="tab-nav-wrapper">
                              <div className="nav-tab  clearfix">
                                 ...
                                 <div className="nav-tab-item col-sm-2 ">
                                    <span>How paradigme Works</span>
                                 </div>
                                 <div className="nav-tab-item col-sm-2 ">
                                    <span>Selling on paradigme</span>
                                 </div>
                                 <div className="nav-tab-item col-sm-2 ">
                                    <span>Reselling on paradigme</span>
                                 </div>
                                 <div className="nav-tab-item col-sm-2">
                                    <span>Buying on paradigme</span>
                                 </div>
                              </div>
                           </div>
                           <div className="tabs-content clearfix">
                                 ...
                                 <div className="col-xs-12 col-sm-12">
                                    ...
                                    <div className="accordion style-2">
                                       <div className="acc-panel">
                                          <div className="acc-title"><span className="acc-icon"></span>What is paradigme?</div>
                                          <div className="acc-body">
                                             <p>paradigme is a marketplace to discover and collect truly unique digital creations by the world's most creative minds. We empower digital creators with the tools to protect and sell their digital creations to their fans and collectors. Artists, photographers, writers, and more use paradigme+ to create and sell their work online through the use of blockchain technology.</p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                       ...
                                       <div className="acc-panel">
                                          <div className="acc-title"><span className="acc-icon"></span>What does paradigme offer?</div>
                                          <div className="acc-body">
                                             <ul>
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>paradigme is currently free to use for all members.However, all transaction fees associated with blockchain interaction are paid by the end user.</p>
                                             <p>On successful sales, paradigme takes a 20% commission on all purchases in Ether and additionally a credit card transaction fee for purchases done through credit card.</p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          <div className="acc-title"><span className="acc-icon"></span>How do I get started?</div>
                                          <div className="acc-body">
                                             <p>paradigme is currently invite-only, however we'd love for you to join us. Please fill out our creator application.</p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          <div className="acc-title"><span className="acc-icon"></span>What do I need to use paradigme?</div>
                                          <div className="acc-body">
                                             <p>paradigme is a web-based service that you can use on both desktop and mobile.</p>
                                             <p>Customers can optionally use third party wallets (e.g. MetaMask, Coinbase Wallet, Trust Wallet) to purchase digital creations using Ether, but otherwise no additional software is needed to use paradigme.</p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          <div className="acc-title"><span className="acc-icon"></span>Contact and support</div>
                                          <div className="acc-body">
                                             <p>You can reach us at support@paradigme.com with any questions or issues. You can also reach us at our Discord community.</p>
                                          </div>
                                       </div>
                                 ...
                                 <div className="col-xs-12 col-sm-12 ">
                                    ...
                                    <div className="accordion style-2">
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>A digital wallet is software that manages your cryptocurrencies and also allows you to interact with blockchain technologies like Ethereum. paradigme uses your digital wallet to publish and sell your digital creations using the Ethereum blockchain.</p>
                                             <p>All creators on paradigme are provided with a hosted digital wallet that is securely managed by paradigme using the highest grade security.</p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          <div className="acc-title"><span className="acc-icon"></span>What is a blockchain wallet?</div>
                                          <div className="acc-body">
                                             <p>Your blockchain wallet is your ID on the Ethereum blockchain and is used to digitally sign all of your creations on paradigme.</p>
                                             <p>When joining paradigme, you have the option to use a personal digital wallet or use a paradigme-issued wallet that is managed by paradigme. If you have a personal wallet, we recommend using it. Learn more.</p>
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>Ethereum is the blockchain that paradigme uses. See what is a blockchain for more details.</p>
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>Ether or Ξ is the cyptocurrency used to interact with Ethereum. It's also the primary cryptocurrency used by paradigme to buy and sell your digital creations.</p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>paradigme is run on the Ethereum blockchain, which is considered a world computer, operated by many computers across the world. This means that interacting with it incurs a transaction fee called gas to compensate the operators of Ethereum.</p>
                                             <p>paradigme has historically paid this gas fee when the blockchain is not congested. However, due to recent high demand on the blockchain, we require gas fees to be paid by the artist or collector.</p>
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             ...
                                             <p>To help alleviate the up front cost of selling on paradigme, we allow artists to defer all gas fees until after an artwork sells. It's important to ensure that your artwork sells for more than the total gas fees for the artwork.</p>
                                       ...
                                       <div className="acc-panel">
                                          <div className="acc-title"><span className="acc-icon"></span>Does paradigme support multiple addresses?</div>
                                          <div className="acc-body">
                                             <p>At this time we don't support multiple addresses. Having multiple addresses can lead to confusion because all creations are signed using the address of the creator. Please contact us at support@paradigme.com if you have any questions and we can assist you.</p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                              ...
                              <div className="tab-info" style={{ display: "none" }}>
                                 <div className="col-xs-12 col-sm-12 ">
                                    <h3 className="mb-5">How paradigme Works</h3>
                                    <div className="accordion style-2">
                                       <div className="acc-panel">
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>paradigme uniquely generates a Non-Fungible Token (NFT) for every creation published. This token is what provides proof of ownership and authenticity of your creation.</p>
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>
                                                paradigme is a platform for creators and has no rights over your creations.  We are committed to ensuring that any digital creation published through paradigme is owned by you (the creator).  You can find more details in our <a href="#">terms of service</a>.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             ...
                                             <p>
                                                Every digital creation uploaded on paradigme is stored in a secure location that's only available to you and collectors, upon purchase.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>
                                                When publishing your creations to the blockchain, paradigme stores your files in a secure location only you (creator) and future owners can access upon purchase.  We only display previews of your image and also allow creators to upload watermarked images for the public to view.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>
                                                Yes!  You can send any creation that you upload or own to another digital wallet.  paradigme makes this easy to do, just go into your store manager and click <strong>Send a Gift</strong>.
                                       </p>
                                             <p>
                                                <strong>Please note.</strong> Always double check that you're sending your creation to the right address.  Once you send a creation through the blockchain, there is no turning back.  paradigme can't retrieve a creation that was sent to the wrong address.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             ...
                                             <p>
                                                If you have additional questions, you can contact us at: <strong>support@paradigme.com</strong>.
                                       </p>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div className="col-xs-12 col-sm-12 ">
                                    ...
                                    <div className="accordion style-2">
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>
                                                paradigme helps you sell your creations by allowing you to set a price or accept offers from buyers to purchase directly from your store or through one of our partner marketplaces.  Besides needing to meet the minimum sales price (the cost of generating your art on the blockchain), you are free to set the price as you please.  All sale prices are based in Ether.
                                       </p>
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             ...
                                             <p>paradigme gives you the flexibility to set your own editions, however we highly discourage setting a very large edition count.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>
                                                paradigme requires setting your sale price in Ether.  Setting your price in Ether allows customers worldwide to be able to purchase your creations using Ether, and doesn't incur any transaction fees.
                                       </p>
                                             <p>
                                                For creators residing in select countries, paradigme supports purchases using a credit card.  When this happens, we will convert your creation's price in Ether to US dollars at the point of sale.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          <div className="acc-title"><span className="acc-icon"></span>Why is paradigme enforcing a minimum sale price?</div>
                                          <div className="acc-body">
                                             <p>
                                                There are production costs associated with creating and selling a unique creation which paradigme is currently paying for. (<a href="#gas-fees" className="goto-link" link="gas-fees">learn more</a>)  Because of this we require a minimum price to ensure that your creation sells for enough to cover these costs.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          <div className="acc-title"><span className="acc-icon"></span>If I sell using paradigme, can I sell the same creations elsewhere?</div>
                                          <div className="acc-body">
                                             <p>
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>
                                                In order to sell your creation, paradigme requires the permission to escrow your creation to ensure that when a sale occurs the buyer receives your work.
                                       </p>
                                             <p>
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             ...
                                             <p>
                                                If you have any questions, reach out to the support team on <a href="#">Discord</a> or at: <a href="#">support@paradigme.com</a>.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             ...
                                             <p>
                                                <strong>3. Support your fellow Creators, start your own Collection.</strong> Explore, collect and invest in unique artworks and creations from other leading digital creators on paradigme.  <a target="_BLANK" href="#" className="primary_text">Start discovering!</a>
                                             </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>Even though your identity has been verified by Civic, the paradigme review team needs to do a final review to approve the identity verification. This can take up to 3 weeks to process. If you don’t receive a response within that timeframe, please reach out to us at <a href="#">support@paradigme.com</a>.</p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>
                                                All creators on paradigme require that you place a minimum bid of 10% above the most recent offer. This is meant to encourage a healthy exchange between collectors when vying for the same artwork.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                              ...
                              <div className="tab-info" style={{ display: "none" }}>
                                 <div className="col-xs-12 col-sm-12 ">
                                    <h3 className="mb-5">Reselling on paradigme</h3>
                                    <div className="accordion style-2">
                                       <div className="acc-panel">
                                          <div className="acc-title"><span className="acc-icon"></span>How do I resell the artworks that I purchase on paradigme?</div>
                                          <div className="acc-body">
                                             <p>Any artwork that you purchase on paradigme can be sold on the secondary market to other collectors.  Through your account manager, you have the option to set a reserve price.  If you don't set a price, anyone can still submit an offer to purchase your artwork.
                                       </p>
                                             <p>
                                       ...
                                       <div className="acc-panel">
                                          <div className="acc-title"><span className="acc-icon"></span>What are the fees associated with reselling on paradigme?</div>
                                          <div className="acc-body">
                                             <p>paradigme witholds 12.5% of each secondary market sale.</p>
                                             <p>
                                                2.5% will go to paradigme and the other <strong>10% will go to the creator as a royalty</strong>.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             ...
                                             <p>In order to accept credit card payments, paradigme will need to act as a custodian, which means that our systems will have access to transfer your artwork to the buyer, upon successful sale.  If you don't feel comfortable giving this permission, you can opt out of this option when setting a price on your work.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>In order to guarantee each sale between you and the buyer, paradigme requires you to give approval to a smart contract whose sole purpose is to faciliate sales and offers.  No one except you can access your artwork even when giving this permission.
                                       </p>
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>In order to guarantee each sale between you and the buyer, paradigme requires you to give approval to a smart contract whose sole purpose is to faciliate sales and offers.
                                       </p>
                                    ...
                                    <div className="accordion style-2">
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             ...
                                             <p>
                                                <strong>Bidding with a Credit Card</strong>.  Once you've provided an offer amount and your credit card details, your bid will be submitted for the creator to review.  If the creator accepts your offer, the creation will be transferred to your paradigme collection.  When the offer is submitted, an authorization for the full bid amount will be placed on your card, however it is not charged.<strong> Your credit card will only be charged after your offer is accepted.</strong> If the offer isn't accepted within 4 days, the offer will automatically be cancelled.
                                       </p>
                                             <p>
                                                <strong>Bidding with Ether</strong>.  Once you've provided an offer amount and confirmed with your Ethereum wallet, your bid will be submitted for the creator to review.  If the creator accepts your offer, the creation will be transferred to your paradigme collection.
                                       </p>
                                             <p>
                                       ...
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>
                                                <strong>Purchases with Ethereum</strong>.  If you purchased your digital creation with Ethereum, your creation resides in your digital wallet.  If you <a href="#">register with paradigme</a>, you can view, showcase and share your creations with the world by connecting your Ethereum wallet.
                                       </p>
                                             <p>
                                                <strong>Purchases with Credit Card</strong>.  If you purchased your digital creation with a credit card, then paradigme will have created a digital wallet for you to store your creation.  You can view your creation by going to <strong>your collection</strong> in your profile.
                                       </p>
                                          </div>
                                       </div>
                                       <div className="acc-panel">
                                          ...
                                          <div className="acc-body">
                                             <p>
                                                When you purchase a digital creation with a credit card, we provide the option for you to save your credit card information for future purchases.  paradigme works with Stripe, a third-party payment gateway to manage your saved credit cards, which means that we never hold any payment information and your information is managed with the most stringent level of security.  You can <a href="#" target="BLANK">learn more here</a>.
                                       </p>
                                             <p>
