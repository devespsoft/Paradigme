...
export default class featurescreator extends Component {
   ...
   validate = () => {
      ...
      if (nameError || categoryNameError || collectionNameError || sellTypeError || priceError || descriptionError || imageError || expiry_dateError || quantityError || editionTypeError) {
         this.setState({
            nameError, categoryNameError, collectionNameError, sellTypeError, priceError, descriptionError, imageError, expiry_dateError, quantityError, editionTypeError
         })
         return false
      }
      return true
                                 ...
                                 <div className="input-col col-xs-6 col-sm-6">
                                    <div className="form-group focus-2">
                                       ...
                                       {this.state.edition_type === '2' ?
                                          <>
                                             <input type="text" className="form-control" disabled value={this.state.quantity} onKeyPress={(event) => {
                                          if (!/^[0-9\b]+$/.test(event.key)) {
                                            event.preventDefault();
                                          }
                                        }}  name="quantity"
                                 ...
                                 <div className={this.state.etherClickActive == 0 ? "tab-info" : "tab-info active"} style={{ display: this.state.etherClickActive == 0 ? 'block' : 'none' }}>
                                    <div className="row">
                                       <div className="col-ml-12 col-xs-12 col-sm-12">
                                             ...
                                             <div className="input-group">
                                                <input type="text" className="form-control "
                                                   placeholder="Card Number"  onKeyPress={(event) => {
                                                    ...
                                                    }} name="cardNumber" onChange={this.onChange} value={this.state.cardNumber} />
                                             </div>
                                          </div>
                                                ...
                                                <div className="input-group">
                                                   <input type="text" className="form-control "
                                                      placeholder="Exp Month" name="expMonth"  onKeyPress={(event) => {
                                                       ...
                                                       }} onChange={this.onChange} value={this.state.expMonth} />
                                                ...
                                                <div className="input-group">
                                                   <input type="text" className="form-control "
                                                      placeholder="Exp Year"  onKeyPress={(event) => {
                                                       ...
                                                       }} name="expYear" onChange={this.onChange} value={this.state.expYear} />
                                        ...
                                        }} placeholder="CVC" name="cvc" onChange={this.onChange} value={this.state.cvc} />
                                                </div>
                                             </div>
                                          </div>
