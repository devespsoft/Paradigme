...
const TITLE = 'paradigme-Itemdetail'
...
export default class itemdetails extends Component {
   ...
   onChange = e => {
      ...
      if (e.target.name === 'purchased_quantity') {
         ...
         if (e.target.value > this.state.getListItem.available_quantity) {
            this.setState({
               errorAvailable: '1'
            })
      ...
      if (this.loginData.length === 0) {
         ...
         if (parseFloat(this.state.bid_price) <= parseFloat(this.state.getListItem?.max_bid)) {
            ...
            if (this.state.getListItem?.sell_type_name === 'Price') {
               if (this.state.purchased_quantity > this.state.getListItem.available_quantity || this.state.purchased_quantity === '0' || this.state.purchased_quantity === '') {
                  this.setState({
                     cryptoPayBtnDesable: false
                  })
                  return false;
                  ...
                  bid_price = (parseFloat(parseFloat(this.state.getListItem?.price).toFixed(2) * parseFloat(this.state.purchased_quantity === '' ? 1 : this.state.purchased_quantity).toFixed(2) + parseFloat(this.state.getUsdBalance?.txn_fee_usd)).toFixed(2))
               }
            }
            else {
            ...
            await axios({
               ...
               // 'amount': bid_price
               data: {
                  "email": this.loginData.data.user_email, "user_address": this.state.ConnectWalletAddress, "sell_type": this.state.getListItem?.sell_type_name, "item_edition_id": this.id, 'item_id': this.state.getListItem?.item_id,
                  'user_id': this.loginData.data.id, 'amount': bid_price, purchased_quantity: this.state.purchased_quantity
               }
            })
               .then(result => {
   ...
   async paymentStripeShow() {
      ...
      const response = await axios({
         method: 'post',
         url: `${config.apiUrl}circlePurchase `,
         headers: { "Authorization": this.loginData?.Token },
         data: {
            "email":this.loginData.data.user_email,"user_id": this.loginData.data.id, "amount": this.state.getListItem?.sell_type_name === 'Price' ?
            (parseFloat(parseFloat(this.state.getListItem?.price).toFixed(2) * parseFloat(this.state.purchased_quantity === '' ? 1 : this.state.purchased_quantity).toFixed(2) + parseFloat(this.state.getUsdBalance?.txn_fee_usd)).toFixed(2))
            :
            this.state.bid_price, "number": this.state.number, "expMonth": this.state.expMonth,
            "expYear": this.state.expYear, "cvv": this.state.cvv, "sell_type": this.state.getListItem?.sell_type_name,
   ...
   plusQuantity() {
      ...
      console.log(this.state.purchased_quantity);
      console.log(qty);

      console.log(this.state.getListItem.available_quantity);
      ...
      return (
         ...
         <>
            <Helmet>
               <title>{TITLE}</title>
               {/* <head>
                  <meta name="description" content={this.state.getListItem?.description} />
                  <meta property="og:title" content={this.state.getListItem?.name} />
                  <meta property="og:image" content={`${config.imageUrl}${this.state.getListItem?.image}`} />
               </head> */}
            </Helmet>
            <Header />
                                                ...
                                                {this.state.getListItem?.image === undefined || this.state.getListItem?.image === '' || this.state.getListItem?.image === null ? '' :
                                                   this.state.getListItem?.file_type === 'image' ?
                                                      ...
                                                      <ModalImage
                                                         ...
                                                         large={`${config.imageUrl}${this.state.getListItem?.image_original}`}
                                                         medium={`${config.imageUrl}${this.state.getListItem?.image_original}`}
                                                   ...
                                                   <div className="row">
                                                      <div className="col-sm-12">
                                                         ...
                                                         <span className="ml-1 h7">
                                                            ...
                                                            <strong>
                                                               <Link to={`${config.baseUrl}featurescreator/${this.state.getListItem?.created_by}`} target="_blank" className="collab-storename secondary_text">{this.state.getListItem?.creator}</Link>
                                                      ...
                                                      <div className="col-sm-12" style={{ paddingTop: "1em" }}>
                                                         ...
                                                         <span className="ml-1 h7">
                                                            ...
                                                            <strong>
                                                               <Link to={`${config.baseUrl}featurescreator/${this.state.getListItem?.owner_id}`} target="_blank" className="collab-storename secondary_text">{this.state.getListItem?.owner}</Link>
                                                      ...
                                                      <div className="col-sm-12" style={{ paddingTop: "1em" }}>
                                                         <span className="h6" style={{ color: '#fff' }}>
                                                            {this.state.getListItem?.nft_type === "Upcoming" ? <p>Start:</p> :
                                                               <p>Expire:</p>
                                                            }
                                                         </span>
                                                         <span className="ml-1 h7">
                                                            <span id="authenticity_url" href="#" className="secondary_text">
                                                               <strong id="edition_count">
                                                                  ...
                                                                  {this.state.getListItem?.nft_type === "Upcoming" ?
                                                                     this.state.getListItem?.start_date !== undefined ?
                                                                     this.state.getListItem?.item_edition_id === 42979 ? 
                                                                     <div className="timer3">
                                                                     <span>Coming soon</span></div>
                                                                     :
                                                                        <div className="timer3">
                                                                           <Countdown
                                                                              date={this.getTimeOfStartDate(this.state.getListItem?.start_date)}
                                                      ...
                                                      <div className="col-sm-12 col-xs-12" style={{ paddingTop: "3px" }}>
                                                         {this.state.getListItem?.explorer_link === null || this.state.getListItem?.explorer_link === undefined || this.state.getListItem?.explorer_link === '' ? ''
                                                            :
                                                            <a href={this.state.getListItem?.explorer_link} target="_blank" className="primary">
                                                               <span className="float-left">View on paradigme Explorer</span> <div className="icon right-arrow float-left" style={{ margin: "6px 7px" }}></div>
                                                            </a>
                                                         }
                                             ...
                                             {this.state.getRelatedItem.map(item => (
                                                ...
                                                <div className="category-2 mix col-md-4">
                                                   <div className="be-post">
                                                      ...
                                                      <Link target="_blank" to={`${config.baseUrl}itemdetails/${item.item_edition_id}`}  className="be-post-title">{item.name}</Link>
                                       ...
                                       <div className="tab-wrapper style-1">
                                          <div className="tab-nav-wrapper">
                                             <div className="nav-tab  clearfix">
                                                ...
                                                <div className={this.state.etherClickActive == 2 ? "nav-tab-item active" : "nav-tab-item"} onClick={this.etherClick.bind(this, 'ccc')}>
                                             <span>Circle Card</span>
                                          </div>
                                             </div>
                                          </div>
                                                      ...
                                                      <div className="col-12 mt-3">
                                                         {this.state.getListItem?.sell_type_name === 'Price' ?
                                                            <>
                                                               ...
                                                               * parseFloat(this.state.purchased_quantity === '' ? 1 : this.state.purchased_quantity).toFixed(2)).toFixed(6)} ETH ~ ${parseFloat(parseFloat(this.state.getListItem?.price).toFixed(2) * parseFloat(this.state.purchased_quantity === '' ? 1 : this.state.purchased_quantity).toFixed(2)).toFixed(2)} <br />
                                                                  ...
                                                                  * parseFloat(this.state.purchased_quantity === '' ? 1 : this.state.purchased_quantity).toFixed(2))
                                                                  + parseFloat(this.state.getUsdBalance?.txn_fee_eth)).toFixed(6)} ETH ~ ${parseFloat(parseFloat(this.state.getListItem?.price).toFixed(2) * parseFloat(this.state.purchased_quantity === '' ? 1 : this.state.purchased_quantity).toFixed(2) + parseFloat(this.state.getUsdBalance?.txn_fee_usd)).toFixed(2)}</strong>

                                                            </>
                                                            :
                                                            <strong>Your offer must be greater than: ${this.state.getListItem?.max_bid}</strong>
                                                         }
                                                         ...
                                                         <div className="input-group">
                                                            {this.state.getListItem?.sell_type_name === 'Price'
                                                               ...
                                                               <>
                                                                  ...
                                                                  }} className="form-control currency  ccbid-price"
                                                                     placeholder="Offer amount" id="bidAmountCC" name="bid_price" value={this.state.bid_price} onChange={this.onChange} required="" />
                                                               </>
                                                            }
                                                      ...
                                                      <PayPalButton
                                                         ...
                                                         onClick={() => {
                                                            ...
                                                            if (this.state.getListItem?.sell_type_name === 'Auction') {
                                                               if (parseFloat(trxamount) <= parseFloat(this.state.getListItem?.max_bid)) {
                                                                  this.setState({
                                                            ...
                                                            else if (this.state.getListItem?.sell_type_name === 'Price') {
                                                               console.log(this.state.purchased_quantity);
                                                               if (this.state.purchased_quantity > this.state.getListItem.available_quantity || this.state.purchased_quantity === '0' || this.state.purchased_quantity === '') {
                                                ...
                                                <div className="col-12 mt-3">
                                                   {this.state.getListItem?.sell_type_name === 'Price' ?
                                                      ...
                                                      * parseFloat(this.state.purchased_quantity === '' ? 1 : this.state.purchased_quantity).toFixed(2)).toFixed(6)} ETH 
                                                      ~ ${parseFloat(parseFloat(this.state.getListItem?.price).toFixed(2) * parseFloat(this.state.purchased_quantity === '' ? 1 : this.state.purchased_quantity).toFixed(2)).toFixed(2)} <br />
                                                         Gas fee : {this.state.getUsdBalance?.txn_fee_eth} ETH ~ ${this.state.getUsdBalance?.txn_fee_usd} <br />
                                                         Total payable : {parseFloat((parseFloat(this.state.getUsdBalance?.price_eth).toFixed(6) 
                                                                  * parseFloat(this.state.purchased_quantity === '' ? 1 : this.state.purchased_quantity).toFixed(2))
                                                                  + parseFloat(this.state.getUsdBalance?.txn_fee_eth)).toFixed(6)} ETH ~ ${parseFloat(parseFloat(this.state.getListItem?.price).toFixed(2) * parseFloat(this.state.purchased_quantity === '' ? 1 : this.state.purchased_quantity).toFixed(2) + parseFloat(this.state.getUsdBalance?.txn_fee_usd)).toFixed(2)}</strong> :
                                        ...
                                        />
                                          ...
                                          <div className="col-12 mt-3">
                                             {this.state.loadingStripe === 0 ?
                                                <button type="submit" className="btn btn-primary col-sm-12 size-1 " disabled={!this.state.number || !this.state.expYear || !this.state.expMonth || !this.state.cvv || this.state.errorAvailable === '1' || this.state.errorAvailable === '2'} onClick={this.paymentStripeShow} >Pay with card</button> :
                                    ...
                                    <div className="col-sm-8">
                                       ...
                                       <div className="row">
                                          ...
                                          <div className="d-inline-block col-sm-4 col-xs-4 text-center mb-3">
                                             ...
                                             {/* <FacebookButton url={url} appId='853727061899556'>
        <FacebookCount url={url} />
        {" Share " + url}
      </FacebookButton> */}

                                             {/* <FacebookProvider appId="853727061899556">
