					...
					<div id="content-block">
						<div className="container be-detail-container account-verify" style={{ paddingTop: '50px' }}>
							...
							{this.state.talentStat === 0 ?
								...
								<div class="alert alert-secondary"><h4 style={{ padding: '22px 20px' }}>Your Account is under process to get verify from Admin, Please wait for approval to "Create NFT".
		</h4></div>
								:
								<>
									<div className="row">
