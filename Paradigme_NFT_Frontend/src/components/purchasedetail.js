 ...
 async cryptoPaymentSucces() {
   ...
   <div class="col-sm-8 login_edit_detail">
      <ul class="list-group task-list-group text-white">
         ...
         <li class="list-group-item list-group-item-action">
            <div class="n-chk"><label class=""><span class=" col-sm-6">Owner:</span><span class=" d-block col-sm-6">{this.state.transactionDetailAPIData?.user_name}</span></label></div>
         </li>
         <li class="list-group-item list-group-item-action">
            <div class="n-chk"><label class=""><span class=" col-sm-6">Price:</span><span class=" d-block col-sm-6">${this.state.transactionDetailAPIData?.amount}</span></label></div>
         </li>
         {/* <li class="list-group-item list-group-item-action">
