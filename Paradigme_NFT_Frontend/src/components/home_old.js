            ...
            <div id="content-block">
                        ...
                        <Carousel showThumbs="false" autoPlay="true" interval="10000" infiniteLoop>
                           ...
                           <div>
                              ...
                              {/* {this.state.getWebImageData?.text3 === '' || this.state.getWebImageData?.text3 === null || this.state.getWebImageData?.text3 === undefined || this.state.getWebImageData?.text3 === "<p><br></p>" ? '' :
                                 <div className="carousel-caption mobile-p-0" style={{ background: "#060891ad", boxShadow: "0 10px 16px 0 rgb(0 0 0 / 20%), 0 6px 20px 0 rgb(0 0 0 / 1" }}>
                                    <div dangerouslySetInnerHTML={{ __html: this.state.getWebImageData?.text3 }}></div>
                                    <span>&nbsp;<Link to={`${config.baseUrl}support`} onClick={this.loading.bind(this)} targrt="_blank" style={{ marginTop: '8px' }} className="btn btn-primary mobile-btn">click here</Link></span>
               ...
               <div className="container-fluid custom-container pr-0 pl-0">
                  <div className="">
                        ...
                        <div className="container">
                           <div className="row">
                              ...
                              <div className="col-md-8 text-center newsletter-form">
                                 ...
                                 <h3>Stay up to date with paradigme</h3>
                                 <br />
                     ...
                     <br /><br />
                     <div className="container-fluid custom-container " id="art">
                              ...
                              <div className="col-md-12">
                                 ...
                                 {this.state.getListArt.length === '' ?
                                    <div className="row _post-container_" style={{ height: '200px' }}>
                                       ...
                                       this.state.getListArt1 === true ? <h4 className="text-center upcomigClass">There isn't any assets available.</h4>
                                       :
                                    <div className="row _post-container_">
                     ...
                     <div className="container-fluid custom-container">
                        <div className="container">
                           <div className="row">
                              <div className="col-md-6">
                                 <h3><strong>Master Creators</strong></h3>
                              </div>
                              <div className="col-md-6 text-right">
