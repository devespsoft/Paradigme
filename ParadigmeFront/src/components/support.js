                  ...
                  <div className="blocks-item border ">
                    <Link to={`${config.baseUrl}supportdetail/1`} className="blocks-item-link">
                      <div className="box-title ">
                        ...
                        <span className="blocks-item-description">Learn how to create an account, set up your wallet, and what you can do on Meme</span>
                      </div>
                    </Link>
                  </div>
                </div>
                  ...
                  <div className="blocks-item border">
                    <Link to={`${config.baseUrl}supportdetail/2`} className="blocks-item-link">
                      <div className="box-title">
                        ...
                        <span className="blocks-item-description">Learn how to purchase your first NFT and understand gas fees and what's gas free on Meme</span>
                      </div>
                    </Link>
                  </div>
                </div>
                  ...
                  <div className="blocks-item border">
                    <Link to={`${config.baseUrl}supportdetail/5`} className="blocks-item-link">
                      <div className="box-title">
                        ...
                        <span className="blocks-item-description">Learn answers to frequently asked questions on Meme</span>
                      </div>
                    </Link>
                  </div>
                </div>
                  ...
                  <div className="blocks-item border">
                    <Link to={`${config.baseUrl}supportdetail/6`} className="blocks-item-link">
                      <div className="box-title ">
                        ...
                        <span className="blocks-item-description">Learn more about anti-fraud and user safety processes on Meme </span>
                      </div>
                    </Link>
                  </div>
                </div>
                  ...
                  <div className="blocks-item border">
                    <Link to={`${config.baseUrl}supportdetail/8`} className="blocks-item-link">
                      <div className="box-title ">
                        ...
                        <span className="blocks-item-description">Learn how you can develop with Meme</span>
                      </div>
                    </Link>
                  </div>
                </div>
