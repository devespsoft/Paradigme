...
export default class googleAuth extends Component {
  ...
  constructor(props) {
    ...
    this.loginData = (!Cookies.get('loginSuccessParadigmeAuth')) ? [] : JSON.parse(Cookies.get('loginSuccessParadigmeAuth'));
  ...
  async twoAuthenticationVerifyAPI(e) {
    ...
    await axios({
      ...
      if (response.data.success === true) {
        ...
        Cookies.set('loginSuccessParadigme', JSON.stringify(this.loginData));
        setTimeout(() => {
