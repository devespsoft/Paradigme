    ...
    return (
      ...
      <>
        ...
        <div className="no-bottom no-top" id="content">
          <div id="top" />
          <section id="subheader" className="text-light" style={{ background:'#000', backgroundSize: 'cover' }}>
                    ...
                    <div className="container" style={{ backgroundSize: 'cover' }}>
                      <div className="row" style={{ backgroundSize: 'cover' }}>
                        ...
                        <div className="col-lg-4" style={{ backgroundSize: 'cover' }}>
                          <br /><br />
                          <div className="padding40 bg-color text-light box-rounded" style={{ }}>
                            <h3>Connect with us</h3>
                            <address className="s1">
                              <span><i className="fa fa-twitter fa-lg" /><a href="https://www.twitter.com/">Follow us on Twitter</a></span>
                              <span><i className="fa fa-instagram fa-lg" /><a href="https://www.instagram.com/">Follow us on Instragram</a></span>
                              <span><i className="fa fa-telegram fa-lg" /><a href="https://t.me/">Join our Telegram group</a></span>
                              <span><i className="fa fa-envelope-o fa-lg" /><a href="mailto:hello@paradigme.io">Email us: hello@paradigme.io</a></span>
                            </address>
                          </div>
                        </div>
                      </div>
