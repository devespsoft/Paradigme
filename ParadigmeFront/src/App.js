...
function App() {
  return (
    <BrowserRouter>
        ...
        <Route path={`${config.baseUrl}collectionlist`} exact component={collectionlist} />
        <Route path={`${config.baseUrl}profilelist`} exact component={profilelist} />
        ...
        <Route path={`${config.baseUrl}nftDetails`} exact component={nftDetails} />
        ...
        <Route path={`${config.baseUrl}adminNfts`} exact component={adminNfts} />
