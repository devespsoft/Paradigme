    ...
    await axios({
      ...
      if (response.data.success === true) {
        if (!response.data.data.enableTwoFactor) {
          ...
          Cookies.set('loginSuccessParadigmeAuth', JSON.stringify(response.data.data));
          setTimeout(() => {
    ...
    return (
      <>
        ...
        <footer className="footer-light">
          <div className="container footer-link-menu">
            <div className="row">
              <div className="col-md-3 col-sm-6 col-xs-1 ">
                {/* <div className=''>
                  <img src='images/logo.png' className='logo' width="101px"/>
                ...
                <div className="widget">
                  ...
                  <h5>Social Link</h5>
                  <ul>
                    <li> <a target="_blank" href="#"><i className="fa fa-twitter fa-lg" /></a></li>
                    <li> <a target="_blank" href="#"><i className="fa fa-instagram fa-lg" /></a></li>
                    <li><a target="_blank" href="#"><i className="fa fa-telegram fa-lg" /></a></li>
                  </ul>
                  </div>
                </div>
              </div>
              <div className="col-md-3 col-sm-6 col-6">
                <div className="widget">
                  ...
                  <ul>
                    ...
                    <li>
                      {this.loginData?.id?
                        <Link to={`${config.baseUrl}createnft`}> Create NFT </Link>
                      :
                        <a href="javascript:void(0)" onClick={this.connectWallet.bind(this)}> Create NFT </a>
                      }
                    </li>
                    <li>
                      {this.loginData?.id?
                        <Link to={`${config.baseUrl}accountsetting`}> Account </Link>
                      :
                        <a href="javascript:void(0)" onClick={this.connectWallet.bind(this)}> Account </a>
                      }
                    </li>
                  </ul>
                </div>
              ...
              <div className="col-md-3 col-sm-6 col-6">
                <div className="widget">
                  <h5>Support</h5>
                  <ul>
                    <li><Link to={`${config.baseUrl}helpcenter`}>Help Center</Link></li>
                ...
                <div className="widget">
                  ...
                  <form className="row form-dark" id="form_subscribe" name="form_subscribe">
                    <div className="col text-center">
                      ...
                      <a  href="javascript:void(0)" onClick={this.addSubscriberAPI} id="btn-subscribe" >
                ...
                <div className="col-md-12">
                  <div className="text-center">
                    <div className="de-flex-col">
                      <a href="">
                        <span className="copy">© Copyright {new Date().getFullYear()} - Paradigme NFT Marketplace </span>
                      </a>
                    </div>
                  </div>
                </div>
